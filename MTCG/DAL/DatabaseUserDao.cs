...
namespace MTCG.DAL
{
    public class DatabaseUserDao: IUserDao
    {
        ...
        private const string UpdateUserCommand = @"UPDATE users SET displayname=@displayname, coins=@coins, bio=@bio, image=@image, elo=@elo, wins=@wins, losses=@losses WHERE name=@name";
